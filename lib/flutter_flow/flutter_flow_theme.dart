...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF959D67);
  late Color secondary = const Color(0xFFF5EDDF);
  late Color tertiary = const Color(0xFF2D2D2D);
  late Color alternate = const Color(0xFFD8DCB3);
  late Color primaryText = const Color(0xFF442D1C);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFBF5EB);
